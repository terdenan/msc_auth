...
type UpdateRequest struct {
	...
	// Types that are assignable to OptionalRole:
	//
	//	*UpdateRequest_Role
	OptionalRole isUpdateRequest_OptionalRole `protobuf_oneof:"optional_role"`
}
...
func (m *UpdateRequest) GetOptionalRole() isUpdateRequest_OptionalRole {
	if m != nil {
		return m.OptionalRole
	}
	return nil
}

func (x *UpdateRequest) GetRole() Role {
	if x, ok := x.GetOptionalRole().(*UpdateRequest_Role); ok {
		return x.Role
	}
	return Role_user
}

type isUpdateRequest_OptionalRole interface {
	isUpdateRequest_OptionalRole()
}

type UpdateRequest_Role struct {
	Role Role `protobuf:"varint,4,opt,name=role,proto3,enum=user_v1.Role,oneof"`
}

func (*UpdateRequest_Role) isUpdateRequest_OptionalRole() {}
...
var file_user_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x69, 0x6c, 0x12, 0x23, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x76, 0x31, 0x2e, 0x52, 0x6f, 0x6c,
	0x65, 0x48, 0x00, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x42, 0x0f, 0x0a, 0x0d, 0x6f, 0x70, 0x74,
	0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x5f, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x1f, 0x0a, 0x0d, 0x44, 0x65,
